...
public class SharepointObject {
	...
	public enum Permission {
		...
		CREATE_ALERTS(0x0000008000000000L),
		CREATE_GROUPS(0x0000000001000000L),
		...
		MANAGE_ALERTS(0x0000004000000000L),
		MANAGE_LISTS(0x0000000000000800L),
		MANAGE_PERMISSIONS(0x0000000002000000L),
		MANAGE_PERSONAL_VIEWS(0x0000000000000200L),
		MANAGE_SUBWEBS(0x0000000000800000L),
		MANAGE_WEB(0x0000000040000000L),
		OPEN(0x0000000000010000L),
		OPEN_ITEMS(0x0000000000000020L),
		...
		VIEW_PAGES(0x0000000000020000L),
