...
public class BatchBuilder {
	...
	public Batch batch(OnError onError, String rootFolder, Method...methods) {
		return new Batch(onError, rootFolder, methods);
	}
	...
	public Method method(int id, Method.Cmd cmd, Field...fields) {
