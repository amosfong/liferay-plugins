 ...
 * @author Ivan Zaera
 */
public class CheckInFileOp {

	public CheckInFileOp(SharepointConnectionImpl sharepointConnectionImpl) {
	}

	public boolean run(String filePath, String comment, CheckInType checkInType)
