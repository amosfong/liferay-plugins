...
page import="com.liferay.so.configurations.search.OrganizationRoleChecker" %><%@
page import="com.liferay.so.configurations.search.UserGroupRoleChecker" %><%@
page import="com.liferay.so.configurations.search.UserRoleChecker" %><%@
