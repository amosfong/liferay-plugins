...
public class SamlSpIdpConnectionPersistenceImpl extends BasePersistenceImpl<SamlSpIdpConnection>
	...
	public SamlSpIdpConnection remove(long samlSpIdpConnectionId)
		...
		return remove(Long.valueOf(samlSpIdpConnectionId));
	}
	...
	protected SamlSpIdpConnection removeImpl(
		...
		try {
			...
			BatchSessionUtil.delete(session, samlSpIdpConnection);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public SamlSpIdpConnection updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, samlSpIdpConnection, merge);
		...
		if (isNew || !SamlSpIdpConnectionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((samlSpIdpConnectionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(samlSpIdpConnectionModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						Long.valueOf(samlSpIdpConnectionModelImpl.getCompanyId())
					};
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					samlSpIdpConnection = list.get(0);
	...
	public int countByC_SIEI(long companyId, String samlIdpEntityId)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_C_SIEI,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_SIEI,
					finderArgs, count);
