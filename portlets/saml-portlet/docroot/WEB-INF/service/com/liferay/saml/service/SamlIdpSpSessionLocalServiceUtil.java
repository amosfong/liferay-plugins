...
/**
 * The utility for the saml idp sp session local service. This utility wraps {@link com.liferay.saml.service.impl.SamlIdpSpSessionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SamlIdpSpSessionLocalServiceUtil {
	...
	*
	* @param samlIdpSpSession the saml idp sp session
	* @param merge whether to merge the saml idp sp session with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	* @return the saml idp sp session that was updated
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.saml.model.SamlIdpSpSession updateSamlIdpSpSession(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSamlIdpSpSession(samlIdpSpSession, merge);
	}
