...
/**
 * The utility for the saml sp auth request local service. This utility wraps {@link com.liferay.saml.service.impl.SamlSpAuthRequestLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SamlSpAuthRequestLocalServiceUtil {
	...
	*/
	public static com.liferay.saml.model.SamlSpAuthRequest updateSamlSpAuthRequest(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSamlSpAuthRequest(samlSpAuthRequest, merge);
	}
