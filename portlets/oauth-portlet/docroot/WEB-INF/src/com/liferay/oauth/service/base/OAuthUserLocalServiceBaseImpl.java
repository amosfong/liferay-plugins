...
/**
 * The base implementation of the o auth user local service.
 *
 * <p>
...
public abstract class OAuthUserLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public OAuthUser addOAuthUser(OAuthUser oAuthUser)
		...
		return oAuthUserPersistence.update(oAuthUser, false);
	}
	...
	public OAuthUser updateOAuthUser(OAuthUser oAuthUser)
		throws SystemException {
		return updateOAuthUser(oAuthUser, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OAuthUser updateOAuthUser(OAuthUser oAuthUser, boolean merge)
		throws SystemException {
		oAuthUser.setNew(false);

		return oAuthUserPersistence.update(oAuthUser, merge);
	}
