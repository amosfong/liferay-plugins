...
/**
 * The base implementation of the source local service.
 *
 * <p>
...
public abstract class SourceLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public Source addSource(Source source) throws SystemException {
		...
		return sourcePersistence.update(source, false);
	}
	...
	public Source updateSource(Source source) throws SystemException {
		return updateSource(source, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Source updateSource(Source source, boolean merge)
		throws SystemException {
		source.setNew(false);

		return sourcePersistence.update(source, merge);
	}
