 ...
 * @author Calvin Keum
 */
public class UpgradeReportDefinitions extends UpgradeProcess {
	...
	protected void updateReportDefinitions() throws Exception {
		...
		try {
			...
			ps = con.prepareStatement("select * from reports_definition");
			...
			while (rs.next()) {
				...
				sb.append("update reports_definition set reportParameters = '");
				sb.append(reportParametersJSONArray.toString());
				sb.append("' where definitionId = ");
