...
/**
 * The utility for the source local service. This utility wraps {@link com.liferay.reports.service.impl.SourceLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SourceLocalServiceUtil {
	...
	*/
	...
	/**
	* Returns the source with the UUID in the group.
	*
	* @param uuid the UUID of source
	* @param groupId the group id of the source
	* @return the source
	* @throws PortalException if a source with the UUID in the group could not be found
	* @throws SystemException if a system exception occurred
	*/
	...
	*
	* @param source the source
	* @param merge whether to merge the source with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	* @return the source that was updated
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.reports.model.Source updateSource(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSource(source, merge);
	}
	...
	*/
	...
	public static com.liferay.reports.model.Source addSource(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addSource(userId, nameMap, driverClassName, driverUrl,
