...
/**
 * The utility for the entry local service. This utility wraps {@link com.liferay.reports.service.impl.EntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
	...
	*/
	...
	public static com.liferay.reports.model.Entry addEntry(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addEntry(userId, definitionId, format, schedulerRequest,
