...
/**
 * The base implementation of the web ex site local service.
 *
 * <p>
...
public abstract class WebExSiteLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements WebExSiteLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public WebExSite addWebExSite(WebExSite webExSite)
		...
		return webExSitePersistence.update(webExSite, false);
	}
	...
	public WebExSite updateWebExSite(WebExSite webExSite)
		throws SystemException {
		return updateWebExSite(webExSite, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WebExSite updateWebExSite(WebExSite webExSite, boolean merge)
		throws SystemException {
		webExSite.setNew(false);

		return webExSitePersistence.update(webExSite, merge);
	}
