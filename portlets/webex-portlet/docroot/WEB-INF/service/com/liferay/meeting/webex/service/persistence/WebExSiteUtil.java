...
public class WebExSiteUtil {
	 ...
	 */
	public static WebExSite update(WebExSite webExSite, boolean merge)
		throws SystemException {
		return getPersistence().update(webExSite, merge);
	}
	...
	public static WebExSite update(WebExSite webExSite, boolean merge,
		...
		return getPersistence().update(webExSite, merge, serviceContext);
	}
	...
	*/
	...
	public static com.liferay.meeting.webex.model.WebExSite updateImpl(
		...
		return getPersistence().updateImpl(webExSite, merge);
	}
