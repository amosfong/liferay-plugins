...
import com.liferay.bbb.service.MeetingEntryLocalService;
...
/**
 * Provides the base implementation for the meeting entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.bbb.service.impl.MeetingEntryLocalServiceImpl}.
 * </p>
 *
 * @author Shinn Lok
 ...
 * @generated
 */
public abstract class MeetingEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MeetingEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.bbb.service.MeetingEntryLocalServiceUtil} to access the meeting entry local service.
	 */
	...
	@Override
	public MeetingEntry addMeetingEntry(MeetingEntry meetingEntry)
		throws SystemException {
		meetingEntry.setNew(true);

		return meetingEntryPersistence.update(meetingEntry);
	}
	 ...
	 */
	@Override
	public MeetingEntry createMeetingEntry(long meetingEntryId) {
		return meetingEntryPersistence.create(meetingEntryId);
	}
	...
	@Override
	public MeetingEntry deleteMeetingEntry(long meetingEntryId)
		throws PortalException, SystemException {
		return meetingEntryPersistence.remove(meetingEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MeetingEntry deleteMeetingEntry(MeetingEntry meetingEntry)
		throws SystemException {
		return meetingEntryPersistence.remove(meetingEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MeetingEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return meetingEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return meetingEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MeetingEntry fetchMeetingEntry(long meetingEntryId)
		throws SystemException {
		return meetingEntryPersistence.fetchByPrimaryKey(meetingEntryId);
	}
	 ...
	 */
	@Override
	public MeetingEntry getMeetingEntry(long meetingEntryId)
		throws PortalException, SystemException {
		return meetingEntryPersistence.findByPrimaryKey(meetingEntryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return meetingEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MeetingEntry> getMeetingEntries(int start, int end)
		throws SystemException {
		return meetingEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMeetingEntriesCount() throws SystemException {
		return meetingEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MeetingEntry updateMeetingEntry(MeetingEntry meetingEntry)
		throws SystemException {
		return meetingEntryPersistence.update(meetingEntry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.bbb.model.MeetingEntry",
			meetingEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = meetingEntryPersistence.getDataSource();
	...
	private MeetingEntryLocalServiceClpInvoker _clpInvoker = new MeetingEntryLocalServiceClpInvoker();
}