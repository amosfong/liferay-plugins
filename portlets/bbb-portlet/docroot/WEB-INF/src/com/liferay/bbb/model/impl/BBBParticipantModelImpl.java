...
/**
 * The base model implementation for the BBBParticipant service. Represents a row in the &quot;BBB_BBBParticipant&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BBBParticipantModelImpl extends BaseModelImpl<BBBParticipant>
	 ...
	 */
	public static final String TABLE_NAME = "BBB_BBBParticipant";
	...
	public static final String TABLE_SQL_CREATE = "create table BBB_BBBParticipant (bbbParticipantId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,bbbMeetingId LONG,name VARCHAR(75) null,emailAddress VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table BBB_BBBParticipant";
	public static final String ORDER_BY_JPQL = " ORDER BY bbbParticipant.bbbParticipantId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY BBB_BBBParticipant.bbbParticipantId ASC";
