...
/**
 * The base model implementation for the BBBServer service. Represents a row in the &quot;BBB_BBBServer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BBBServerModelImpl extends BaseModelImpl<BBBServer>
	 ...
	 */
	public static final String TABLE_NAME = "BBB_BBBServer";
	...
	public static final String TABLE_SQL_CREATE = "create table BBB_BBBServer (bbbServerId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,url VARCHAR(75) null,secret VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table BBB_BBBServer";
	public static final String ORDER_BY_JPQL = " ORDER BY bbbServer.bbbServerId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY BBB_BBBServer.bbbServerId ASC";
	...
	public static long BBBSERVERID_COLUMN_BITMASK = 2L;
