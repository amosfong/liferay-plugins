...
/**
 * Provides the local service interface for MeetingServer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Shinn Lok
 * @see MeetingServerLocalServiceUtil
...
public interface MeetingServerLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MeetingServerLocalServiceUtil} to access the meeting server local service. Add custom service methods to {@link com.liferay.bbb.service.impl.MeetingServerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
